...
It is stateless because all visualization information (data, type, and configuration) is provided through parameters to 
GenerateViz, so no persistent internal state is required. 
