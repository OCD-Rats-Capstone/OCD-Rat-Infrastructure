...
\begin{itemize}
  ...
  \item \textbf{Module 7: Data Processing Pipeline Module - Medium testing priority. }Reasoning is same as above.
...
\begin{itemize}
    ...
    \item \textbf{How test will be performed:} Pytest assertions. Call the query module's generate_sql() function with parameter -> user_query and then pass the result into a database query.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{How test will be performed:} Pytest assertions. Call the query module's ask_question() function with parameter -> user_phrase.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Input Case:} submit sql statement to db connection "SELECT rat_id FROM rats"
...
\begin{itemize}
    ...
    \item \textbf{Input Case 1:} simple filter set of easily verifiable data (rat_id = 5) run on execute_filters_query() function
    \item \textbf{Output Case 1:} pandas dataframe of selected records
    \item \textbf{Input Case 2:} simple filter set of multiple filters run on execute_filters_query() function
    \item \textbf{Output Case 2:} pandas dataframe of selected records
    \item \textbf{Input Case 3:} disjoint filter set run on execute_filters_query() function
...
\begin{itemize}
    ...
    \item \textbf{Input Case 1:} submit X and Y value labels to _build_query
    \item \textbf{Output Case 1:} pandas dataframe of datapoints
    \item \textbf{Input Case 2:} submit X and Y value labels to _build_linechart_query
    \item \textbf{Output Case 2:} pandas dataframe of datapoints
     \item \textbf{Input Case 3:} submit X and Y and M value labels to _build_heatmap_query
