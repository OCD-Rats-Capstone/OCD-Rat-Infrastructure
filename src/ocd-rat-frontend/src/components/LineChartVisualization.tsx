...
export function LineChartVisualization({ data, loading, error }: LineChartVisualizationProps) {
  if (loading) {
    return (
  ...
  if (!data || data.labels.length === 0) {
    return (
      <Card className="w-full border-yellow-200 bg-yellow-50">
        ...
        <CardContent>
          <p className="text-yellow-700">No data found for the selected time period and metric.</p>
        </CardContent>
      </Card>
    );
  }
